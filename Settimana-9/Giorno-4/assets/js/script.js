            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    data.forEach(function (element) {
                        var capo = new Prodotto(element.id, element.codprod, element.collezione, element.capo, element.modello, element.quantita, element.colore, element.prezzoivaesclusa, element.prezzoivainclusa, element.disponibile, element.saldo);
                        console.log(capo);
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error('Si è verificato un errore durante la richiesta:', error_1);
                    return [3 /*break*/, 5];
